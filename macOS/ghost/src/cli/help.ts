...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      "gui actor run pointer.main.narrate --text \"Opening Settings\"",
      "gui actor run spotlight.focus.rect --padding 12 --blur 16 -",
      "gui actor run spotlight.focus.circ --padding 8 --blur 24 -",
  ...
  },
  {
    ...
    aliases: [],
    usage: ["gui actor run <name>.rect [--padding <pixels>] [--blur <pixels>] -"],
    examples: [
      "gui actor run spotlight.focus.rect --padding 12 --blur 16 -",
  ...
  },
  {
    ...
    aliases: [],
    usage: ["gui actor run <name>.circ [--padding <pixels>] [--blur <pixels>] -"],
    examples: [
