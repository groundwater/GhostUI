...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    aliases: [],
    usage: ["gui actor spawn pointer <name> [--duration-scale <scale>]", "gui actor spawn canvas <name>", "gui actor spawn spotlight <name>"],
    examples: [
      "gui actor spawn pointer pointer.main",
      "gui actor spawn canvas canvas.notes",
      "gui actor spawn spotlight spotlight.focus",
  ...
  },
  {
    ...
    related: ["actor", "actor run move", "actor run click", "actor run drag", "actor run scroll", "actor run think", "actor run narrate", "actor run rect", "actor run circ", "actor run on", "actor run off", "actor run color", "actor run draw", "actor run text", "actor run clear", "actor run dismiss"],
  },
  {
    id: "actor run draw",
