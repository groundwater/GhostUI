...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "This is the intent-first top-level alias for the existing AX click path.",
    ],
  ...
  },
  {
    ...
    notes: [
      ...
      "Uses the existing CG scroll injection path under the intent-first surface.",
    ],
  ...
  },
  {
    ...
    summary: "Send a key combo, special key, or text string through the existing keyboard input path.",
    aliases: [],
    usage: ["gui shortcut <combo|key|text>"],
    examples: [
      "gui shortcut cmd+n",
      "gui shortcut return",
    ...
    notes: [
      "This is the intent-first top-level alias for `gui cg key`.",
  ...
  },
  {
    ...
    notes: [
      ...
      "When passed an `ax.cursor`, this reuses the cursor-aware type path.",
      "When passed a plain AX target, this reuses the existing AX type behavior.",
    ],
